...
class MetricsComponentTest {
    ...
    void testCreateMetricsWithWrongValue() {
        assertThrows(BadMetricsValueException.class, ()->{
            component = new Abstractness(new AbstractnessData(10, 12));
        });
        assertThrows(BadMetricsValueException.class, ()->{
            component = new Abstractness(new AbstractnessData(-10, 5));
        });

        assertThrows(BadMetricsValueException.class, ()->{
            component = new Instability(10, -5);
        });
        assertThrows(BadMetricsValueException.class, ()->{
            component = new Instability(-5, 10);
        });

        assertThrows(BadMetricsValueException.class, ()->{
            component = new NormalizedDistance(2,2);
        });
        assertThrows(BadMetricsValueException.class, ()->{
            component = new NormalizedDistance(-1, -1);
        });
    }
