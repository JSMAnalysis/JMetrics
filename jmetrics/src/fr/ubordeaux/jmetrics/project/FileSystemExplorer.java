...
public interface FileSystemExplorer {
    ...
    /**
     * Explores the subdirectory of a given project corresponding to a given path and generates a {@link ProjectComponent}'s tree
     * representing the structure of the sub-part of the Java project that it contains.
     * @param path The path leading to the project's root directory.
